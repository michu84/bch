...
// ATSC A/336 audio watermarking specification: m=7, t=13, primitive = 1 + x^6 + x^7, generator is a very long 77th order polynomial:
...
// Phobos Lander BCH(127,113,2): m=7, t=2, primitive = 1 + x^3 + x^7, generator = 1 + x^1 + x^2 + x^4 + x^5 + x^6 + x^8 + x^9 + x^14
